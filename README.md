...
To świadomie odseparowany snapshot portfolio. Nie zawiera bazy danych, panelu klienta, umów, danych klientów, danych dostępowych, konfiguracji produkcyjnej ani historii wdrożeniowej.
